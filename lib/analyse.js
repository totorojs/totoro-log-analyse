...
function parseDayResult(orders) {
    ...
    averageValue(overview, overview.succ, 'averageTC', 'averageCov', 'averageDuration')
...
function parseResult(data) {
   ...
   Object.keys(data).forEach(function(date) {
       ...
       sumValue(overview, dayInfo, 'succ', 'failure', 'averageTC', 'averageCov', 'averageDuration')
   ...
   averageValue(overview, Object.keys(data).length, 'averageTC', 'averageCov', 'averageDuration')
